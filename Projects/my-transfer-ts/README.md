...
docker images
docker run -d --restart=always --name malvina-front_container -p 3987:80 malvina-front
docker run -d --restart=always --name malvina-front_container -p 3987:80 novakvova/malvina-front
docker ps -a
```
